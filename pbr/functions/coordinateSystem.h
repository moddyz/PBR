...
PBR_API
inline void FnCoordinateSystem( const Vec3f& i_vector, Vec3f& o_vector1, Vec3f& o_vector2 )
{
    ...
    {
        o_vector1 = Vec3f( -i_vector.Z(), 0, i_vector.X() );
    }
    else
    {
        o_vector1 = Vec3f( 0, i_vector.Z(), -i_vector.Y() );
    }
