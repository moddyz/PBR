...
PBR_API
inline void BoundsExpand( const Bounds2i& i_bounds, const int& i_factor, Bounds2i& o_bounds )
{
...
PBR_API
inline void BoundsExpand( const Bounds2f& i_bounds, const float& i_factor, Bounds2f& o_bounds )
{
    o_bounds.Min()[ 0 ] = i_bounds.Min()[ 0 ] - i_factor;
    o_bounds.Min()[ 1 ] = i_bounds.Min()[ 1 ] - i_factor;
...
PBR_API
inline void BoundsExpand( const Bounds3i& i_bounds, const int& i_factor, Bounds3i& o_bounds )
{
    o_bounds.Min()[ 0 ] = i_bounds.Min()[ 0 ] - i_factor;
    o_bounds.Min()[ 1 ] = i_bounds.Min()[ 1 ] - i_factor;
...
PBR_API
inline void BoundsExpand( const Bounds3f& i_bounds, const float& i_factor, Bounds3f& o_bounds )
{
    o_bounds.Min()[ 0 ] = i_bounds.Min()[ 0 ] - i_factor;
    o_bounds.Min()[ 1 ] = i_bounds.Min()[ 1 ] - i_factor;
    o_bounds.Min()[ 2 ] = i_bounds.Min()[ 2 ] - i_factor;
