...
public:
    ...
    Mat44Int operator+( const Mat44Int& i_matrix )
    {
        return Mat44Int( m_elements[ 0 ] + i_matrix.m_elements[ 0 ],
    ...
    Mat44Int operator*( const int& i_scalar )
    {
        return Mat44Int( m_elements[ 0 ] * i_scalar,
